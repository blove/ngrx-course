...
// todo: declare DeleteResort action
...
export type ResortActions =
  // todo: add DeleteResorce to type union
  SearchResorts | SearchResortsFail | SearchResortsSuccess | SelectResort;
